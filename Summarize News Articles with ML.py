...
Original file is located at
    https://colab.research.google.com/drive/1kk9_dBTrMUsq0_hiEN0vN_TeyeflOwet
"""
...
df_1 = pd.read_csv("/content/business_data.csv")
df_2 = pd.read_csv("/content/education_data.csv")
df_3 = pd.read_csv("/content/entertainment_data.csv")
...
sns_year = sns.countplot(df['category'], color = 'darkcyan')
plt.xticks(rotation=45)
sns_year.set(xlabel = "category", ylabel = "Count", title = "Distribution of Publication according")

df['url'].value_counts()

plt.rcParams['figure.figsize'] = [15, 15]
sns.set(font_scale = 1, style = 'whitegrid')
df_url = df.url.value_counts().head(80)


sns.barplot(x=df_url, y=df_url.index)
sns_year.set(xlabel = "count", ylabel = "url", title = "the most freq url")

df['url'] = df['url'].replace("The Associated Press", "Associated Press")
...
print ("The length of the summary is : ", len(summaries[0]))
summaries[0]
